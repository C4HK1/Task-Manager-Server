...
namespace services {
    ...
    public:
        ...
        auto get_manager() -> models::profile;
        ...
        auto get_profile_received_invites(std::vector<models::invite> &invites) -> DATA_BASE_EXECUTION_STATUS;

        auto get_profile_sended_invites(std::vector<models::invite> &invites) -> DATA_BASE_EXECUTION_STATUS;

        auto delete_profile() -> DATA_BASE_EXECUTION_STATUS;

        auto loggin_profile(const std::string &login, const std::string &password, models::profile &profile) -> DATA_BASE_EXECUTION_STATUS;

        auto profile_authenticate(models::profile &profile) -> DATA_BASE_EXECUTION_STATUS;
        ...
        //Join part
        auto get_profile_rooms(std::vector<models::room> &rooms) -> DATA_BASE_EXECUTION_STATUS;

        auto get_profile_tasks(std::vector<models::task> &tasks) -> DATA_BASE_EXECUTION_STATUS;
        ...
        auto get_room_tasks(
                const u_int64_t room_creator_ID,
                const std::string &room_name, 
                std::vector<models::task> &tasks) -> DATA_BASE_EXECUTION_STATUS;
