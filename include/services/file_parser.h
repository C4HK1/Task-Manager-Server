...
public:
    static auto read_text_file_to_string(const std::string& path, std::string &buffer) -> FILE_PARSER_EXECUTION_STATUS;
    static auto read_binary_file_to_string(const std::string& path, std::string &buffer) -> FILE_PARSER_EXECUTION_STATUS;
